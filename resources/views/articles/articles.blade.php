...
<div class="container mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-10">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="flex flex-col bg-white rounded shadow">
                <img src="{{ asset($article->photo) }}" class="w-full h-40 object-cover rounded-t" alt="{{ $article->title }}">
    ...
    <aside class="space-y-6">
        ...
        <form action="#" class="relative">
            ...
            <button class="absolute right-4 top-2 text-green-500"><i class="fas fa-search"></i></button>
        </form>
